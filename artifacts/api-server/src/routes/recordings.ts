...
// NOTE: the admin-facing GET/POST /admin/recordings endpoints live in
// academies.ts, next to the academy-linking routes that consume them.
// Don't add copies here — this router mounts first, so a duplicate would
// silently shadow those.
